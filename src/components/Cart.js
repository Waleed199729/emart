...
const Cart = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    navigate("/orderhistory", {
      state: { orderData: formValues, cartItem: cartItems }, //navigate ke sath state ki form me data bejh raha hu jis ko aage receive kru ga user ka data print krwane ke liye
    });
  };
