...
const Products = () => {
    ...
    const filterProduct = ( cat ) => {                                            //filter the products as per category like men, women etc
        ...
        return (
            <>
                <div className='buttons d-flex justify-content-center mb-5 pb-5'>
                    ...
                    {filter.map((product) => {                     //card format
                        return (
                            <>
                                <Link to={`/products/${product.id}`} className='col-md-3 mb-4'>                       
                                    <div className="zoom card h-100 text-center p-4" key={product.id}>
